...
**Discontinued: 150-max MME.** No longer part of the default workflow as of May 2026. The lineup-construction precision required for 150-max in coarse-lever optimizers produces diminishing returns relative to the cognitive cost. Small-portfolio formats (1–20 lineups) deliver better process discipline and equivalent or superior risk-adjusted returns.
...
- [ ] At least one course-history-boost cross-referenced sub-5% own candidate considered (filing pattern from PGA Championship 2026 Smalley/Rai miss)
...
- [ ] Course history boost + sub-5% own scan completed
...
- [ ] Course history boost + sub-5% own candidates considered for at least 2-3 lineups
