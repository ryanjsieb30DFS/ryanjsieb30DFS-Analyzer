...
If check 8 or 10 fails, **swap the offending lineup before locking**. Checks 9 and 11 are CONSIDERATION checks — they fail only when a candidate was never looked at, and they are satisfied by a deliberate "no," never by adding a driver to clear a threshold.
